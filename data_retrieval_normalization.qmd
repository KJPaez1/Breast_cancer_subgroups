...
tumor_and_nontumor_matrix <- cbind(tumor_expr_matrix, nontumor_expr_matrix) # first tumor
colnames(tumor_and_nontumor_matrix) = NULL
rownames(tumor_and_nontumor_matrix) = NULL

sample_type = as.factor(c(rep("Tumor vs Tumor", 905), 
...
boxplot(d~g_mine,
        outline = F,
         border = c("cornflowerblue", "#E69F00"),
        col = "white",
        cex.lab = 1.8,
        cex.axis = 1.5,
        cex.sub = 1.5,
