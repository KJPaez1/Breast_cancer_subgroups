...
brca_table <- clinical_BRCA_xena_1 |> 
  filter(sample_type == "Primary Tumor" | sample_type == "Solid Tissue Normal") |>
  filter(complete.cases(sample_type, pathologic_stage, Histological_type, pam50)) |> 
  tbl_summary(
    include = c(
      age_at_diagnosis,
      race,
...
pca_pam50 + theme(text = element_text(size = 18))
